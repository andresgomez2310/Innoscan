...
async function HomePage() {
    ...
    const [productosRes, ideasRes, escaneosRes] = await Promise.all([
        ...
        supabase.from("ideas").select("*, productos(nombre)").order("created_at", {
            ascending: false
        }),
        supabase.from("escaneos").select("*, productos(nombre)").order("created_at", {
            ascending: false
        }).limit(10)
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89d2ce00._.js.map